...
- **147 tests** — taxonomy validation, model inference, column disambiguation, data generation
...
| `finetype-model` | Candle CharCNN inference, column-mode disambiguation (54 tests) | `candle-core`, `candle-nn` |
